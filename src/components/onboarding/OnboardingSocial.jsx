...
function OnboardingSocial() {
  ...
  const validateAndNext = () => {
    ...
    } else if (!/^\d{10}$/.test(profileData.mobile.trim().replace(/[\s-]/g, ''))) {
  ...
  const firstName = profileData.firstName || 'Your'
    ...
    <OnboardingLayout>
      <div className="onboarding-form">
        ...
        <div className="input-group">
          ...
          <div className={`input-with-icon-inline ${errors.email ? 'input-error' : ''}`}>
        ...
        <div className="input-group">
          ...
          <div className={`input-with-icon-inline ${errors.mobile ? 'input-error' : ''}`}>
            <svg className="field-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {/* Twitter */}
        <div className="input-group">
          <label className="input-label" htmlFor="twitter">Twitter</label>
